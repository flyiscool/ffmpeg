...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=host --disable-ffmpeg --disable-ffprobe --disable-ffplay --disable-programs --disable-symver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avresample --disable-avfilter --disable-avdevice --disable-postproc --enable-swscale --enable-swresample --enable-avcodec --enable-avformat --enable-small --enable-cross-compile --arch=arm --target-os=linux --cross-prefix=arm-linux-gnueabihf- --enable-shared --disable-gpl --enable-nonfree --enable-openssl --enable-pthreads --enable-error-resilience --enable-debug --disable-encoders --disable-hwaccels --disable-muxers --disable-indevs --disable-outdevs --disable-devices --disable-filters --disable-decoder=ssh264_ss268 --disable-decoder=sshevc_ss268 --shlibdir=host/dynamic --libdir=host/static --pkg-config=pkg-config --extra-cflags=' -I./../../project/release/include -I./../3rdparty/include -I./../3rdparty/include/sstar -DFFMPEG_LIBRARY_VERSION="ffmpeg_version..git_commit:d76ef58..build_time:20230414" -g -rdynamic -funwind-tables -ffunction-sections' --extra-ldflags=' -L./../../project/release/nvr/i2m/common/glibc/8.2.1/mi_libs/dynamic -L./../3rdparty/lib/8.2.1'
prefix=host
LIBDIR=$(DESTDIR)host/static
SHLIBDIR=$(DESTDIR)host/dynamic
INCDIR=$(DESTDIR)${prefix}/include
BINDIR=$(DESTDIR)${prefix}/bin
DATADIR=$(DESTDIR)${prefix}/share/ffmpeg
DOCDIR=$(DESTDIR)${prefix}/share/doc/ffmpeg
MANDIR=$(DESTDIR)${prefix}/share/man
PKGCONFIGDIR=$(DESTDIR)host/static/pkgconfig
INSTALL_NAME_DIR=
SRC_PATH=.
SRC_LINK=.
...
CC_IDENT=gcc 8.2.1 (GNU Toolchain for the A-profile Architecture 8.2-2018-08 (arm-rel-8.23)
ARCH=arm
INTRINSICS=neon
EXTERN_PREFIX=
...
OBJCC=arm-linux-gnueabihf-gcc
LD=arm-linux-gnueabihf-gcc
DEPCC=arm-linux-gnueabihf-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=arm-linux-gnueabihf-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
NM_CMD=arm-linux-gnueabihf-nm -g
RANLIB=arm-linux-gnueabihf-ranlib -D
...
CFLAGS=  -I./../../project/release/include -I./../3rdparty/include -I./../3rdparty/include/sstar -DFFMPEG_LIBRARY_VERSION=ffmpeg_version..git_commit:d76ef58..build_time:20230414 -g -rdynamic -funwind-tables -ffunction-sections -march=armv7-a -std=c11 -fomit-frame-pointer -marm -fPIC -pthread  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I./../../project/release/include -I./../3rdparty/include -I./../3rdparty/include/sstar -DFFMPEG_LIBRARY_VERSION=ffmpeg_version..git_commit:d76ef58..build_time:20230414 -g -rdynamic -funwind-tables -ffunction-sections -march=armv7-a -fPIC -g
...
LD_PATH=-L
DLLTOOL=
WINDRES=arm-linux-gnueabihf-windres
DEPWINDRES=arm-linux-gnueabihf-gcc
DOXYGEN=doxygen
LDFLAGS= -L./../../project/release/nvr/i2m/common/glibc/8.2.1/mi_libs/dynamic -L./../3rdparty/lib/8.2.1  -march=armv7-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avformat=-lm -lssl -lcrypto
...
CONFIG_SSH264_DECODER=yes
CONFIG_SSHEVC_DECODER=yes
!CONFIG_SSH264_SS268_DECODER=yes
!CONFIG_SSHEVC_SS268_DECODER=yes
